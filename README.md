...
| `mcp` | Run styx as an MCP stdio server (JSON-RPC 2.0) exposing `route`, `budget_status`, and `record_usage` to OpenClaw and any MCP host (see [`docs/openclaw-integration.md`](docs/openclaw-integration.md)) |
