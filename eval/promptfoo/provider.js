...
// 3B model warm across the run. We use a custom provider (not promptfoo's native
...
const MODEL = process.env.STYX_BRAIN_MODEL || 'llama3.2:3b';
...
class StyxBrainProvider {
  ...
  async callApi(prompt) {
    ...
    // unparseable content (the 3B model occasionally returns empty under load).
    let content = '';
